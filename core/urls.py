...
urlpatterns = [
    ...
    path(
        "empleados/exportar/",
        views.exportar_empleados_excel,
        name="exportar_empleados_excel"
    ),

    path(
        "empleados/pdf/",
        views.exportar_empleados_pdf,
        name="exportar_empleados_pdf"
    ),
    ...
    path(
        "productos/pdf/",
        views.exportar_productos_pdf,
        name="exportar_productos_pdf"
    ),
    path(
    "productos/nuevo/",
    ...
    path(
        ...
        views.exportar_proveedores_excel,
        name="exportar_proveedores_excel"
    ),

    path(
        "proveedores/pdf/",
        views.exportar_proveedores_pdf,
        name="exportar_proveedores_pdf"
    ),
